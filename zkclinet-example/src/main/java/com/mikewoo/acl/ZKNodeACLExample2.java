...
/**
 * ZK节点ACL示例，ACL: custom digest，自定义用户认证访问
 *
 * @author Eric Gui
 * @date 2018/8/31
 */
@Slf4j
public class ZKNodeACLExample2 implements Watcher {
    ...
    public ZKNodeACLExample2() {
    }

    public ZKNodeACLExample2(String zkServerPath) {
        try {
            zooKeeper = new ZooKeeper(zkServerPath, TIMEOUT, new ZKNodeACLExample2());
        } catch (IOException e) {
    ...
    public static void main(String[] args) throws Exception {
        ZKNodeACLExample2 client = new ZKNodeACLExample2(ZK_STANDALONE_SERVER_PATH);
